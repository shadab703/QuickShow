...
const AddShows = () => {
    ...
    return nowPlayingMovies.length > 0 ? (
        <>
            ...
            <div className='overflow-x-auto pb-4'>
                <div className='group flex flex-wrap gap-4 mt-4 w-max'>
                    {nowPlayingMovies.map((movie) => (
                        <div onClick={() => { setSelectedMovie(movie.id); scrollTo(0, 0) }} key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`}>
            ...
            <div className='mt-6'>
                <label className='block font-medium mb-2 text-sm'>Select Date and Time</label>
